<?php
error_reporting(0);  
    require_once './forms/php-i18n/i18n.class.php'; session_start(); if (isset($_GET["lang"])){function clean($string){$string =    str_replace(' ', '-', $string);return preg_replace('/[^A-Za-z0-9\-]/', '', $string);}$_SESSION["lang"]=clean($_POST["lang"]);} $i18n = new i18n('./forms/php-i18n/lang/lang_{LANGUAGE}.json', './forms/php-i18n/langcache/', 'ar','l'); $i18n->init();
$header = '<!DOCTYPE html> <html lang="'.$i18n->getappliedLang().'"> <head> <meta charset="UTF-8"> <meta name="description" > <meta name="keywords" > <meta name="viewport" content="width=device-width, initial-scale=1.0"> <meta http-equiv="X-UA-Compatible" content="ie=edge"> <title>'.l::title.'</title> <!-- Google Font --> <link href="https://fonts.googleapis.com/css?family=Work+Sans:400,500,600,700,800,900&display=swap" rel="stylesheet"> <link href="https://fonts.googleapis.com/css?family=Poppins:400,500,600,700&display=swap" rel="stylesheet"> <!-- Css Styles --> <link rel="stylesheet" href="css/bootstrap.min.css" type="text/css"> <link rel="stylesheet" href="css/font-awesome.min.css" type="text/css"> <link rel="stylesheet" href="css/elegant-icons.css" type="text/css"> <link rel="stylesheet" href="css/owl.carousel.min.css" type="text/css"> <link rel="stylesheet" href="css/magnific-popup.css" type="text/css"> <link rel="stylesheet" href="css/slicknav.min.css" type="text/css"> <link rel="stylesheet" href="css/style.css" type="text/css"> </head> <body> <!-- Page Preloder --> <div id="preloder"> <div class="loader"></div> </div> <!-- Header Section Begin --> <header class="header-section"> <div class="container"> <div class="nav-menu"> <a href="index.php"> <img src="img/fits logo.jpeg" alt="" style="width: 95px;height: 55px;"> </a> <nav class="mainmenu mobile-menu"> <ul> <li class="active"><a href="./index.php">'.l::menu_home.'</a></li> <li><a href="./about-us.php">'.l::menu_about.'</a></li> <li><a href="./speaker.php"style="font-size:14px">'.l::menu_speaker.'</a></li> <li><a href="./schedule.php"style="font-size:14px">'.l::menu_schedule.'</a></li> <li><a href="./blog.php"style="font-size:14px">'.l::menu_blog.'</a></li> <li><a href="./contact.php"style="font-size:14px">'.l::menu_contact.'</a></li> <li><a href="./partners.php"style="font-size:14px">'.l::menu_partners.'</a></li> <li><div class="switch-lang"> <div class="current-lang"> <img class="lang-flag" src="img/'.$i18n->getappliedLang().'.png"/> <p class="lang-text">'.l($i18n->getappliedLang()).'</p> </div> <div class="lang-dropdown">';
    $languages=array('fr','ar');
    $temp="";
    foreach($languages as $l) { if ($l != $i18n->getappliedLang()){ $temp=$temp.'<div class="selecting-lang" lang="'.$l.'"><img class="lang-flag" src="img/'.$l.'.png"/> <p class="lang-text">'.l($l).'</p></div>';}};
